...
```bash
node skills/web-clone/scripts/init-clone.mjs <站名> --url <原站URL>
```
...
```bash
node skills/web-clone/scripts/recon-site.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON \
  --label original

node skills/web-clone/scripts/asset-harvest.mjs \
...
node skills/web-clone/scripts/network-capture.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON/network \
  --label original

node skills/web-clone/scripts/route-crawl.mjs \
  --url <原站URL> \
...
node skills/web-clone/scripts/interaction-probe.mjs \
  --url <原站URL> \
  --out ~/projects/website-clones/<站名>-clone/RECON/interactions \
  --label original

node skills/web-clone/scripts/sourcemap-hunt.mjs \
  --recon ~/projects/website-clones/<站名>-clone/RECON/original-recon.json \
...
```bash
node skills/web-clone/scripts/dna-scaffold.mjs \
  --recon ~/projects/website-clones/<站名>-clone/RECON/original-recon.json \
...
node skills/web-clone/scripts/compare-recon.mjs \
...
node skills/web-clone/scripts/visual-diff.mjs \
...
node skills/web-clone/scripts/audit-clone.mjs \
